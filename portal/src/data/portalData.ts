...
export const digitalEmployees: DigitalEmployee[] = [
  ...
  },
  {
    ...
    welcome:
      "您好！我是故障处置员。故障处置、根因定位与恢复验证。<br><br>我可以帮您完成以下工作：<br>• 故障诊断 - 围绕具体告警或工单分析故障类型<br>• 根因定位 - 结合拓扑、日志快速定位故障根源<br>• 自动修复 - 低风险操作自动执行，高风险等待授权<br>• 故障恢复 - 自动执行恢复策略，验证业务可用性<br>• 闭环复盘 - 清除告警、更新工单并沉淀复盘建议<br><br>如果只是查询告警列表、告警数量或告警详情，请交给数据分析员处理。",
  },
  {
    id: "resource",
    name: "资产管理员",
